...
export default async function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="rounded-lg bg-linear-to-br from-violet-500 to-indigo-600 px-8 py-10">
      ...
      <section>
        ...
        {recentUploads.length === 0 ? (
          <p className="mt-4 rounded-lg border border-dashed border-slate-200 bg-white p-8 text-center text-sm text-slate-400">
